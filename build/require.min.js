...
"",$method$$="appendChild",!$dom$$.wasObserver&&($dom$$.wasObserver=!0,$observer$$($dom$$,function($arr$$){var $tar$$=[],$ele$$;$arr$$.forEach(function($JSCompiler_inline_result$$0_i$$inline_14_v$$){$ele$$=$JSCompiler_inline_result$$0_i$$inline_14_v$$.target;a:{for($JSCompiler_inline_result$$0_i$$inline_14_v$$=0;$JSCompiler_inline_result$$0_i$$inline_14_v$$<$tar$$.length;$JSCompiler_inline_result$$0_i$$inline_14_v$$++)if($ele$$==$tar$$[$JSCompiler_inline_result$$0_i$$inline_14_v$$]){$JSCompiler_inline_result$$0_i$$inline_14_v$$=
!0;break a}$JSCompiler_inline_result$$0_i$$inline_14_v$$=!1}$JSCompiler_inline_result$$0_i$$inline_14_v$$||($ele$$.wasRequire=0,$tar$$.push($ele$$))});$requireTag$$($tar$$)}))),$dom$$[$method$$]($frag$$)):$global$$.body.appendChild($frag$$)}$res$$1_str$$[1]?$evalScripts$$($dom$$,$res$$1_str$$[1],$fn$$):$fn$$&&$fn$$()}function $tpl$$($dom$$,$html$$,$fn$$,$item$$){var $data$$31_data$$,$obj$$21_url$$=$att$$($dom$$,["bind","bind-remote","data-url","bind-call"]);$obj$$21_url$$&&($data$$31_data$$=$xhr$$("post",
...
(function($g$$,$und$$){for(var $o$$=function $$o$$$($obj$$){for(var $k$$ in $obj$$)$o$$[$k$$]=$obj$$[$k$$]},$reg$$=/([^&=]+)=([^&]*)/g,$pars$$=location.search.substring(1),$m$$;$m$$=$reg$$.exec($pars$$);)$o$$[decodeURIComponent($m$$[1])]=decodeURIComponent($m$$[2]);Base.Options=$o$$})(window);
