...
cdncache:$gopt$$.cdncache,notify:$gopt$$.notify,success:$gopt$$.success,progress:$gopt$$.progress}:$opt$$)},include:$include$$}})(window);(function($g$$,$und$$){for(var $o$$=function $$o$$$($obj$$){for(var $k$$ in $obj$$)$o$$[$k$$]=$obj$$[$k$$]},$reg$$=/([^&=]+)=([^&]*)/g,$pars$$=location.search.substring(1),$m$$;$m$$=$reg$$.exec($pars$$);)$o$$[decodeURIComponent($m$$[1])]=decodeURIComponent($m$$[2]);$g$$.Options=Base.Options=$o$$})(window);
